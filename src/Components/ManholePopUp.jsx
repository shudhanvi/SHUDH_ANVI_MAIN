...
const ManholePopUp = ({ selectedLocation, selectedOps, onClose, onGenerateReport }) => {
  ...
  return (
    <div className="manhole-popup-box bg-grey-50 rounded-xl border-1 border-gray-300 shadow-md shadow-gray-500 w-full">
      {/* Header */}
