...
const Header = () => {
  ...
  return (
  <header className="w-[95%] md:w-[90%] fixed p-2 rounded-2xl max-w-[1200px] bg-black m-auto flex justify-around flex-wrap place-items-center align-middle font-[Sansation] text-white">
    <img
