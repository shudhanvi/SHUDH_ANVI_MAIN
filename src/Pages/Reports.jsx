...
export default function Reports() {
  ...
  return (
    <>
      ...
      {/* Filters */}
      <section className="flex flex-wrap gap-2 justify-center mb-10 mt-5 p-4 rounded-xl w-full max-w-6xl mx-auto">
        {/* Division Dropdown */}
        <div className="flex-1 max-w-[350px]">
          <select
            value={selectedDivision}
            ...
            className="w-full shadow-md rounded-xl px-4 py-2.5"
          >
            <option value="">Select Division</option>
            {divisions.map((div) => (
              <option key={div} value={div}>
        ...
        <button
          onClick={handleSearch}
          className="self-start bg-[#1A8BA8] text-white px-6 py-2 rounded-xl hover:bg-[#166f86] flex items-center gap-2 shadow-xl btn-hover transition duration-500"
        >
                ...
                {allDivisionList.map((d) => (
                  <div key={d.division} className="bg-white p-4 rounded-xl shadow-sm flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="bg-gray-100 px-6 py-2 rounded-lg hover:bg-[#1A8BA8] transition btn-hover  duration-500"
                    >
                      View
                    </button>
                  </div>
            ...
            <div className="space-y-4">
              ...
              {displayReportsState.map((r) => (
                <div key={r.id} className="bg-white p-4 rounded-xl shadow-sm flex justify-between items-center">
                  ...
                  <button
                    onClick={() => setPopupReport(r)}
                    className="bg-gray-100 px-6 py-2 rounded-lg hover:bg-[#1A8BA8] btn-hover transition duration-500"
                  >
                    View
                  </button>
                </div>
