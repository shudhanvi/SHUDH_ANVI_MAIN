...
export default function Robots() {
  ...
  return (
    <>
      ...
      <section className="w-full max-w-[1400px] px-5">
            ...
            <div className="bg-white w-11/12 lg:w-3/4 rounded-lg p-6 overflow-y-auto max-h-[100vh] relative right-5 top-5 shadow-2xl border border-gray-300">
              ...
              <div className="flex flex-row justify-between ">
                <div className="w-[45%] ">
                  <div className="flex flex-col justify-start text-gray-500 w-full">
                    <span className="text-start">
                      <img
                        ...
                        className="inline-block w-4 h-4 mr-1 "
                      />
                      Division:{selectedDevice.division}
                    </span>
                    <br />
                    <span className="text-start">
                      <img
                        ...
                        className="inline-block w-4 h-4 mr-1 "
                      />
                      Section:{selectedDevice.area}
                    </span>
                  </div>
                  <div className="grid grid-cols-2 w-full text-start text-gray-500 mt-5 gap-y-6">
                    <span>
                      <Calendar
                        className="inline-block w-10 h-10 mr-1 bg-blue-100 p-2 rounded-md"
                        color="#348feb"
                      />
                      Date :{" "}
                    ...
                    <span>
                      ...
                      Waste Collected :{" "}
                      <b className="text-black font-semibold">
                        {selectedDevice.waste_collected_kg}kgs
                      </b>
                    </span>
                    <span>
                      <Clock
                      ...
                      Task Duration:{" "}
                      <b className="text-black font-semibold">
                        {selectedDevice.operation_time_minutes} mins
                      </b>
                    </span>
                    <span>
                      <Bot
                      ...
                      Robo Id:{" "}
                      <b className="text-black font-semibold">
                        {selectedDevice.robo_id}
                      </b>
                    </span>
                    <span className="text-2xl text-black pl-2">
                      Gas Level:
                      <span
                        style={{
                          color:
                            selectedDevice.gas_level?.toLowerCase() === "high"
                              ? "red"
                              : selectedDevice.gas_level?.toLowerCase() ===
                                "medium"
                              ? "orange"
                              : "green",
                        }}
                      >
                        ...
                        {selectedDevice.gas_level
                          ? selectedDevice.gas_level.charAt(0).toUpperCase() +
                            selectedDevice.gas_level.slice(1).toLowerCase()
                          : ""}
                      </span>
                    </span>
                    <span>
                  ...
                  <h1 className=" font-semibold px-3 pt-8 text-start">
                  ...
                  <div className=" w-full text-start text-gray-500 mt-5 bg-gray-200 rounded-lg ">
                    ...
                    <div className="bd-gray">
                      {selectedDevice?.location ? (
                        (() => {
                          const [lat, lng] = selectedDevice.location
                            .split(",")
                            .map(Number);
                          return (
                            <MapContainer
                  ...
                  <div className="mt-5 flex justify-center w-full pb-10">
                    <p className=" flex items-center justify-center h-15 bg-[#1A8BA8] w-full text-white rounded-md">
                      <Download
                ...
                <div className="  w-[45%]">
                  <h1 className="text-start mt-2 ">
                    {" "}
                    <span className="inline-block w-3 h-3 mr-5">
                      <Funnel />
                    </span>
                    Filter by Date
                  </h1>
                  <div className="flex flex-row w-full justify-between mb-5 mt-3 gap-2">
                    ...
                    <div>
                      <button
                        className="bg-[#1A8BA8] text-white rounded-md h-10 text-sm px-6 mt-8.5"
                        onClick={apply}
                      >
                        Filter
                      </button>
