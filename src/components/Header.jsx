    ...
    <header className="max-h-[200px] max-w-full flex flex-col mx-auto bg-white border-b-2 border-[#1D97AA] shadow-md shadow-[#1F252E1A]  sticky top-0 z-900">
      ...
      <div className="h-[60px] w-full px-[18px] mt-[10px]">
        <nav className="flex justify-start items-center gap-1 underline-offset-5">
          <Link
            to="/"
            className={`font-bold p-[14px] flex justify-center items-center w-[166px] text-[14px]  transition-all duration-150 border-b-2 ${currentPageStyle("") === "active"
          ...
          <Link
            to="/robots"
            className={`font-bold p-[14px] flex justify-center items-center w-[166px]  text-[14px] transition-all duration-150 border-b-2 ${currentPageStyle("robots") === "active"
              ? "bg-[#DCF5F9] border-b-[#1D97AA] text-[#1E9AB0]"
              : "border-b-transparent text-[#65758B] "
          ...
          <Link
            to="/reports"
            className={`font-bold p-[14px] flex justify-center items-center w-[166px] text-[14px]  transition-all duration-150 border-b-2 ${currentPageStyle("reports") === "active"
              ? "bg-[#DCF5F9] border-b-[#1D97AA] text-[#1E9AB0]"
              : "border-b-transparent text-[#65758B] "
              }`}
          >
          ...
          <Link
            to="/highlights"
            className={`font-bold p-[14px] flex justify-center items-center w-[166px] text-[14px]  transition-all duration-150 border-b-2 ${currentPageStyle("highlights") === "active"
              ? "bg-[#DCF5F9] border-b-[#1D97AA] text-[#1E9AB0]"
              : "border-b-transparent text-[#65758B] "
